...
\textbf{Pooled analysis} (Centered log ratio $\sim$ Income + Study, all 6 cohorts): only 2/104 species survived FDR correction, as differences in sample material (air vs.\ sewage vs.\ dust vs.\ vehicle surfaces) drive stronger compositional shifts than economic group.\\
...
Both identify globally prevalent taxa also detected in our data: \textit{Cutibacterium acnes} (HIC-enriched, $q=7.1\times10^{-14}$) and \textit{Micrococcus luteus} (HIC-enriched, $q=2.7\times10^{-3}$). 
...
2. Standardised sampling: uniform surface swabs across cities eliminated material-type heterogeneity that limited our pooled result to 2 significant species.
